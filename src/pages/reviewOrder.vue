    ...
    <div class="cart-container">
        <div class="product-banner">
            <div class="product-nav">
                <b-nav>
                    <b-nav-item>
                        <router-link class="banner-link" :to="{ name: 'homepage' }">
                            {{ $t("nav-home") }}
                        </router-link>
                    </b-nav-item>
                    <span class="seperator">/</span>
                    <b-nav-item>
                        <router-link class="banner-link" :to="{ name: 'shoppingCart' }">
                            {{ $t("shopping-cart") }}
                        </router-link>
                    ...
                    <span class="seperator">/</span>
                    <b-nav-item>
                        <router-link class="banner-link" :to="{ name: 'reviewOrder' }">
                            {{ $t("review-order") }}
                        </router-link>
                    </b-nav-item>
                </b-nav>
            ...
            <div class="product-svg">
                ...
                <span class="product-text">Review Order</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="67.669" height="56.793" viewBox="0 0 67.669 56.793">
        ...
        <div class="container">
            ...
            <div>
                <b-row>
                    <b-col sm="4" md="12" lg="8">
                        <formWIzard :defaultStep="3" />
                    </b-col>
                    <b-col class="pricing-col" sm="4" md="12" lg="4">
                        <shippingMain />
                    </b-col>
                </b-row>
            </div>
...
import shippingMain from '../components/shippingMain.vue';
export default {
