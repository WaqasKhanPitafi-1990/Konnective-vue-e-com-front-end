        ...
        <div class="product-banner">
            <div class="product-nav">
                <b-nav>
                    ...
                    <b-nav-item>
                        <router-link class="banner-link" style="color: white;" :to="{ name: 'shoppingCart' }">
                            {{ $t("Cart") }}
                        </router-link>
                    </b-nav-item>
                </b-nav>
            ...
            <div class="product-svg">
                ...
                <span class="product-text"> {{ $t("shopping-cart") }}</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="67.669" height="56.793" viewBox="0 0 67.669 56.793">
            ...
            <div>
                <b-row>
                    <b-col  sm="4" md="12" lg="8">
                        <FormWIzard :defaultStep="1" />
                    </b-col>

                    <b-col  style="margin-top: 4rem;" class="pricing-col" cols="12" sm="4" md="12" lg="4">
                        <productPricing />
                    </b-col>
                </b-row>
            </div>
